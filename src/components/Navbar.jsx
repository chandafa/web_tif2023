  ...
  return (
    <>
      ...
      <div className="flex justify-between relative top-3 lg:hidden">
        ...
        <div className={`w-12 h-12 rounded-full flex justify-center items-center `} id="UserButton">
          <img src="/user.png" alt="" className="w-full h-12" />
        </div>

        {isMenuOpen && <div className="fixed inset-0 bg-black opacity-50 z-10" onClick={toggleMenu}></div>}

        <div className={`fixed top-0 left-0 h-full w-64  shadow-lg transform transition-transform duration-300 ease-in-out ${isMenuOpen ? "translate-x-0" : "-translate-x-full"}`} id="IsiNavbar">
          <ul className="mt-8">
            <li className="mb-4">
            ...
            <li>
              <a href="#Abouts" className="text-white opacity-80 text-lg font-bold">
                About
              </a>
            </li>
          </ul>
      ...
      <div className="flex justify-between relative top-3 hidden lg:flex">
        <div>
          <img src="/LogoPHI.png" className="w-14 h-14 rounded-full" alt="" />
        </div>
        <ul className="mt-2 flex gap-5">
          ...
          <li>
            <a href="#Abouts" className="text-white opacity-80 text-[1rem] font-semibold">
              About
            </a>
          </li>
        </ul>
